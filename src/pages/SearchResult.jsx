...
import ChildClassifications from '../components/ChildClassifications'
...
function SearchResult(props) {
    ...
    return (
        <div className='pt-24 w-100 mx-auto h-auto pb-28'>
            <div className="w-3/4 mx-auto">
                <div className="flex p-6">
                   {props.searchResult && <h1 className="text-xl text-gray-600 font-bold flex-1">{props.searchResult.length} results</h1>}
                </div>
                        ...
                        props.searchResult.map((result) => {
                            return (
                                <div className="rounded-2xl relative p-6  bg-white lowercase filter drop-shadow-2xl border-t-2 border-gray-100 mb-4">
                                    ...
                                    <div className="absolute bottom-0 mb-6 mt-4">
            ...
            {viewChildModel && <ChildClassifications data={childData} setData={setChildData} getChildData={getChildData} showBooks={showBooks}/>}
        </div>
    )
}
